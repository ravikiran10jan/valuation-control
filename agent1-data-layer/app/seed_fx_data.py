...
async def clear_all_tables(db: AsyncSession) -> None:
    ...
    await db.execute(text("DELETE FROM commodity_details"))
    await db.execute(text("DELETE FROM structured_product_details"))
    await db.execute(text("DELETE FROM bond_details"))
